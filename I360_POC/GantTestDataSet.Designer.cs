...
namespace I360_POC.GantTestDataSetTableAdapters {
...
SELECT UniqueId, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceId, ResourceIds, ReminderInfo, RecurrenceInfo, PercentComplete, CustomField1 FROM Appointments WHERE (UniqueId = @UniqueId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::I360_POC.Properties.Settings.Default.scheduleStorageConnectionString;
        }
